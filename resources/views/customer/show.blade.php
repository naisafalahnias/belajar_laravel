        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="{{ route('customer.update', $customer->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Gender</label>
                            <input type="radio" class="form-check-input" name="gender" value="laki-laki" disabled>Laki-Laki 
                            <input type="radio" class="form-check-input" name="gender" value="Perempuan" disabled>Perempuan
                        </div>
                        <br>
                        <div class="form-group">
                            <label>Contact</label>
